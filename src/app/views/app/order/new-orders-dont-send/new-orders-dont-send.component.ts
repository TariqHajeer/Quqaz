...
@Component({
  ...
  templateUrl: './new-orders-dont-send.component.html',
  styleUrls: ['./new-orders-dont-send.component.scss']
})
export class NewOrdersDontSendComponent implements OnInit {
  ...
  get() {
    this.OrderService.NewOrderDontSned().subscribe(res => {
      // console.log(res)
      this.orders = res
